...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col relative top-64 lg:top-24  text-center md:text-left md:flex-row max-w-6xl justify-evenly mx-auto items-center z-0 pt-20 pb-8 px-4  mb-52 mt-32 lg:mt-8">
